...
# # #      presion_arterial = self.entry_presion.get()
# # #      frecuencia_cardiaca  = self.entry_frecuencia.get()

# # #     # Crear un diccionario o estructura con los datos ingresados
# # #      datos_usuario = {
# # #         "temperatura": float(temperatura),
# # #         "presion": float(presion_arterial),
# # #         "frecuencia": int(frecuencia_cardiaca)
# # #      }
...
# #         if datos_historial:
# #             mostrar_historial(datos_historial)
# #         else:
# #             messagebox.showinfo("Historial", "No hay datos disponibles.")
...
# # // este anda con las recomendaciones y diagnosticos, graficos normales y no personalizados
...
#             # Mapear el resultado a una descripción
...
#             # Mostrar diagnóstico descriptivo y recomendaciones
...
#             guardar_diagnostico(cuil, datos_usuario, resultado_numerico)
...
class SistemaDiagnosticoApp:
    ...
    def mostrar_historial(self, cuil):
        """
        Obtiene el historial desde la base de datos y muestra gráficos personalizados.
        """
        datos_historial = obtener_historial(cuil)  # Cargar historial del paciente
        if datos_historial:
            # Convertir el historial en un formato adecuado para mostrar_historial
            datos = {
            ...
            mostrar_historial(datos)  # Llama a la función de historial_visualization
        else:
            messagebox.showinfo("Historial", "No hay datos disponibles.")
